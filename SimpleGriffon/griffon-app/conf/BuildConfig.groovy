...
deploy {
    application {
        title = 'SimpleGriffon 0.1'
        vendor = System.properties['user.name']
        homepage = 'http://localhost/SimpleGriffon'
        description {
            complete = 'SimpleGriffon 0.1'
            oneline  = 'SimpleGriffon 0.1'
            minimal  = 'SimpleGriffon 0.1'
            tooltip  = 'SimpleGriffon 0.1'
        }
        icon {
            fallback {
...
app.fileType = '.groovy'
app.defaultPackageName = 'simplegriffon'
